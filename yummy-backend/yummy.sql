CREATE DATABASE  IF NOT EXISTS `yummy_spicy` ;
USE `yummy_spicy`;

DROP TABLE IF EXISTS `address_book`;
CREATE TABLE `address_book` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'main key',
  `user_id` bigint NOT NULL COMMENT 'user id',
  `consignee` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT 'receiver',
  ...
  `detail` varchar(200) CHARACTER SET utf8mb4  DEFAULT NULL COMMENT 'address detail',
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin COMMENT='category of dishes';
